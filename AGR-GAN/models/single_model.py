...
# 训练
        ...
        #'''设置学习率'''
            ...
            # initialize optimizers '''使用Adam优化器'''
   ...
   # criterionGAN: 
    ...
    def backward_G(self, epoch):
        ...
        if self.opt.vgg > 0:
            ...
            L_TV =  networks.L_TV()             #自己添加的
            L_color = networks.L_color()
            ...
            Loss_TV = L_TV(self.fake_B)
            Loss_Col = torch.mean(L_color(self.fake_B))
            self.loss_G = self.loss_G_A + self.loss_vgg_b*vgg_w  + Loss_TV +Loss_Col #自己修改
        elif self.opt.fcn > 0:
            ...
            if self.opt.patchD:
                ...
                self.loss_G = self.loss_G_A + self.loss_fcn_b*vgg_w                     #不走这条路
